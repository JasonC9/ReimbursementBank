...
/**
 * Servlet implementation class PendingApps
 */
public class PendingApps extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		PreparedStatement ps=mydatabase.getInstance().conn.prepareStatement("SELECT * FROM REIMBURSEMENT WHERE STATUS='PENDING'");
		...
		out.println("<html>\r\n"
				...
				+ "			<li><a href='AnD.html'>Approve or Deny</a></li>\r\n"
				+ " </ul>"
				+ "			<body>\r\n"
				+ "        <h1>\r\n"
				+ "        Welcome "+user+"!\r\n"
